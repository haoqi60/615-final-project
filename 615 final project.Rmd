...
dbpathT='/Users/mac/Downloads/CovidDataWithTweets&Reddit/Covid-tweets-en.db'
dbpathR='/Users/mac/Downloads/CovidDataWithTweets&Reddit/Covid-reddit-en.db'
...
```{r }
# spread data
covid=read.csv('/Users/mac/Desktop/shiny/us_covid19_daily.csv')%>%select(date,positiveIncrease)
...
```{r}
# spread data
covid=read.csv('/Users/mac/Documents/GitHub/mapping1/Trinity-project-G2/COVID-trends-shiny/us_states_covid19_daily.csv')%>%
